...
\noindent A Tableau Dashboard can be found \href[]{https://us-west-2b.online.tableau.com/t/kalliltest01/views/tableau_dashboard_step_3/Prototype_01}{\textcolor{blue}{here}}. But the next page presents the dashboard built.
